...
- **[2.8] Sexual Violence and Abuse** covers non-consensual sexual acts and the sexualisation of children, including a report that a work sexualises minors. Do not file that under [2.1]; [2.1] is bodily injury. Do not spend [2.8] on commentary about a controversy — cite it for the sexual content itself, not for how fans or critics discuss it.
- **[4.1] Respect** covers an attack on a person: an insult, a slur, a demeaning label aimed at someone. **[4.2] Tone and Register** covers register alone, such as crudeness with no target. An insult directed at a named person is [4.1], and calling it a matter of tone understates it.
- **[4.3] Care and Compassion** covers the treatment of people in difficulty. It is not the section for commercial capture: an article steering a reader toward a product is [3.3] when it creates a false impression and [5.1] when the inducement is the issue.
- **[4.5] Honesty in Relationships** is interpersonal. Commercial academic fraud — an essay mill selling work a student will submit as their own — is [3.3] Non-Deception, because the person deceived is the grader.
- **[6.1] Rule of Law and Due Process** requires governance by public rules: a law, a court, a regulator, a named authority. An internal approval step, a deployment gate, or a company's own sign-off process is not due process, and citing [6.1] for one credits a product feature with a constitutional value.
- **[5.3] Mental Health and Self-Harm** requires suicide, self-injury, an eating disorder, or psychological crisis. Ordinary self-help, stress advice, or recreational drug talk is [5.1]. A statistic about how often a harm occurs is not itself [5.3].
